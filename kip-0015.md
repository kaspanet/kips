...
Another possible argument: a proof of exclusion from the `mergeset` of a specific chain block seems unuseful. 
To prove exclusion from a period such as a day you would need a linearly long proof for proving exclusion from each 
chain block.
